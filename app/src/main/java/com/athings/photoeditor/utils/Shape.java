...
public class Shape {
    ...
    public Shape(PointF[] points, Bitmap b, int[] exceptionIndex, int offsetX, int offsetY, boolean isScrapBook, int index, boolean isDelete, Bitmap del, Bitmap scl, int screenWidth) {
        ...
        this.tempScrapBookPadding = 25;
        this.scrapBookPadding = 25;
    ...
    static {
        scrapBookRotation = new int[]{MATRIX_MODE_MOVE_DOWN, -13, -7, -12, MATRIX_MODE_MOVE_RIGHT, MATRIX_MODE_ZOOM_IN, -9, MATRIX_MODE_MOVE_LEFT, MATRIX_MODE_ZOOM_OUT};
    }
    ...
    private void setScrapBookBitmapPosition(int index, boolean isChangeRatio, int width, int height) {
        ...
        this.scrapBookPadding = 25 * scale;
    ...
    public void resetDashPaths() {
        ...
        this.dashPathVertical.lineTo(this.bitmapWidth / 2, 6 * this.bitmapHeight / 5);
        ...
        this.dashPathHorizontal.lineTo(6 * this.bitmapWidth / 5, this.bitmapHeight / 2);
    }
